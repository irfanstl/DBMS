    ...
    <div className="flex bg-[#f8f9fa] dark:bg-gray-900 min-h-screen pt-20 transition-colors duration-300">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        <div className="text-gray-900 dark:text-gray-100">
          ...
          {activeTab === 'restaurants' && <RestaurantManagementView />}
...
function RestaurantManagementView() {
  return <div className="p-12 text-center text-gray-400 font-bold bg-white dark:bg-gray-800 rounded-3xl border border-dashed border-gray-200 dark:border-gray-700">Connect Restaurant API for dynamic listing</div>;
}
