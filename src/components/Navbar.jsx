        ...
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center gap-4 lg:gap-8">
            <Link to="/" className="flex items-center gap-2 cursor-pointer group">
              <div className="bg-white shadow-md shadow-mango-200 p-1.5 rounded-xl group-hover:scale-105 transition-transform flex items-center justify-center w-10 h-10">
                <img src="/logo.png" alt="MangoBite" className="w-full h-full object-contain" onError={(e) => { e.target.onerror = null; e.target.src = 'C:/Users/irfan/OneDrive/Documents/clg/DBMS UI/src/assets/logo.png' }} />
              </div>
