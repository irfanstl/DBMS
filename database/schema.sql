...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `check_item_availability` BEFORE INSERT ON `orders_items` FOR EACH ROW BEGIN
  IF (SELECT is_available FROM menu_items WHERE item_id = NEW.item_id) = FALSE THEN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_order_total` AFTER INSERT ON `orders_items` FOR EACH ROW BEGIN
  UPDATE orders
  SET total_amount = (
...
--
-- Dumping routines for database 'mangobite'
--
/*!50003 DROP FUNCTION IF EXISTS `get_total_items` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `get_total_items`(p_order_id INT) RETURNS int
    DETERMINISTIC
BEGIN
  DECLARE v_count INT;
...
BEGIN
  SELECT o.order_id, o.status, o.total_amount,
         o.ordered_at, m.name, oi.quantity, oi.unit_price
  FROM orders o
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `summarize_orders` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `summarize_orders`()
BEGIN
  ...
  DECLARE order_cursor CURSOR FOR
    SELECT order_id, total_amount, delivery_fee FROM orders;
  ...
  read_loop: LOOP
    ...
    SELECT v_order_id AS OrderID, (v_total + v_delivery) AS GrandTotal;
  END LOOP;
...
-- Dump completed on 2026-04-18 23:49:41
